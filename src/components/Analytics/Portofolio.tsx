...
const Portofolio = () => {
  ...
  return (
    <>
      ...
      <p className='adress-text'><span className='address-copy-text'>Account: {address.slice(0, 5)} ... {address.slice(58, 62)} <ClipboardCopy text={address} /></span></p>
      <Row className='g-0'>
        <Col xs={12} lg={7}>
            ...
            <Row>
              <Col xs={12} lg={6} className=''>
                ...
                <table className='text-white font-size-sm'>
                  <tr>
                    <td className='text-intense-green' width={'35%'}><AccountBalanceWalletIcon className='m-t-n-xxs' style={{ fontSize: '16px' }} /> Tokens</td>
                    <td width={'35%'} align='right'>$300.78</td>
                    <td width={'30%'} align='right'>60%</td>
                  </tr>
                  <tr>
                    <td className='text-info'><WorkspacesIcon className='m-t-n-xxs' style={{ fontSize: '16px' }} /> Pools</td>
                    <td align='right'>$100</td>
                    <td align='right'>15%</td>
                  </tr>
                  <tr>
                    <td className='text-primary'><AgricultureIcon className='m-t-n-xxs' style={{fontSize: '16px'}} /> Farms</td>
